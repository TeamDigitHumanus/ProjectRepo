...
namespace DigitCashier
{
    public partial class Cashier : Form
    {
        ...
        private void btnAdd_Click(object sender, EventArgs e)
        {
            ...
            {
                if ((prdID.Equals(prdArray[i, 0])) && (prdArray[i, 4].Contains("kg"))) //Checking if product is priced by weight
                {
                    ...
                    if (dialogResult == DialogResult.OK)    //Calculating the price according to weight
                    {
                        ...
                        richtxtEntries.AppendText(prdArray[i, 1] + "       " + (float.Parse(prdArray[i, 2]) * kg).ToString("0.00") + " " + prdArray[i, 3] + "\r");
                    }
                }
            ...
            string[] separator = { " ", "\n", "SEK" };  //Reading the values from the text box
